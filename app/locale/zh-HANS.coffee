module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  new_home:
    ...
    our_courses: "我们的游戏编程课程尤其<strong>适用于教室教学的需求</strong>。无编程经验的老师也可轻松授课。"
    watch_how: "看一看CodeCombat是怎样转变人们学习计算机的方式。"
  ...
  signup:
    ...
    teacher_ready_to_create_class: "您已经准备好了创建第一个班级!"
    teacher_students_can_start_now: "您的学生马上就可以开始学习他们的第一课: 计算机科学介绍。"
    teacher_list_create_class: "在下一个页面里, 您将能够创建一个新的班级。"
    teacher_list_add_students: "通过点击浏览班级的链接, 给您的学生发送班级代码或者网址URL链接, 将学生添加到班级里来。如果有他们的邮件地址, 也可以直接发邮件邀请他们。"
    teacher_list_resource_hub_1: "仔细阅读"
    teacher_list_resource_hub_3: ", 里面提供了每一关的解题思路。 在"
    teacher_list_resource_hub_4: "资源库"
    teacher_list_resource_hub_5: "里有每一课的课程手册、活动和其他资源。"
...
#    referrer_help: "For example: from another teacher, a conference, your students, Code.org, etc."
  ...
  account_settings:
    ...
    wrong_email: "邮箱地址错误"
    wrong_password: "密码错误"
    use_gravatar: "通过注册Gravatar来更改您的个人资料图片"
...
#    not_assigned_modal_full_body_3: "Please select fewer students, or reach out to __supportEmail__ for assistance."
    ...
    enrollments_blurb: "学生需要一个许可，以便在第一课程后访问内容。"
...
#    revoking: "Revoking..."
    ...
    teacher_quest_teach_methods: "帮助你的学生学习如何 `call methods`。"
    ...
    teacher_quest_teach_strings: "学习字符串 `strings`。"
    ...
    teacher_quest_teach_loops: "让你的学生在循环中学习 `loops`。"
    ...
    teacher_quest_teach_variables: "学习变量 `variables`."
...
#    advanced_html_tags: "Advanced HTML Tags"
    algorithm_average: "求平均数"
    algorithm_find_minmax: "求最大最小值运算"
...
#    algorithm_search_graph: "Algorithm Search Graph"
    ...
    array_2d: "二维数组"
    array_index: "数组索引"
    array_iterating: "数组遍历"
    array_literals: "数组字面量"
    array_searching: "数组搜索"
    array_sorting: "数组排序"
    arrays: "数组"
...
#    strings_substrings: "Substring"
    ...
    variables: "变量"
    vectors: "向量"
    while_condition_loops: "带条件的While循环"
    while_loops_simple: "While循环"
    while_loops_nested: "While嵌套循环"
    xy_coordinates: "笛卡尔坐标系"
